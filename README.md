Place `vscript.pluto` in `Stand/Lua Scripts` and start it.   vscript will automatically update itself, but you can force an update with the update option at the bottom of the options list.
